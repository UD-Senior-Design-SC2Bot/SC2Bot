...
Moves paddle by way of a scripted bot that will
perfectly follow the ball.
...
while done == False:       
    ...
    # "Perfect" AI of player 1 computer
    if not bar1_y == circle_y + 7.5:
        if bar1_y < circle_y + 5:
            bar1_y += ai_speed
            input_opcode = 2
        if  bar1_y > circle_y - 40:
            bar1_y -= ai_speed
            input_opcode = 1
    else:
        bar1_y == circle_y + 7.5

    # AI of the player 2 computer
    if circle_x >= 305.:
